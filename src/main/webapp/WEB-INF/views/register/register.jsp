...
<%--                                    </div>--%>
                                    ...
                                    <div class="form-outline mb-4">
                                        <input name="su_username" type="text" id="form3Example2" class="form-control" placeholder="Username" />
                                        <label class="form-label" for="form3Example2">Username</label>
                                    </div>

                                    <!-- Email input -->
                                    <div class="form-outline mb-4">
                                        <input name="su_password" type="password" id="form3Example3" class="form-control" placeholder="Password" />
...
0                                    <!-- Checkbox -->
                        ...
                        <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                            <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                <h9 class="mb-4">We are more than just a company</h9>
                                <h10 class="small mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                                    exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</h10>
                            </div>
                        </div>
                    </div>
                </div>
