  ...
  <section class="fruit_section layout_padding-top">
      <div class="container">
          ...
          <div class="row layout_padding2">
              ...
              <div class="col-md-4 d-flex justify-content-center align-items-center">
                  <div class="fruit_img-box d-flex justify-content-center align-items-center">
                      <img src="${pageContext.request.contextPath}/assets/user/dist/images/hoacuoi8.png" alt=""  alt="" class="" width="250px"/>
                  </div>
              </div>
          </div>
          <div class="row layout_padding2">
              ...
              <div class="col-md-4 d-flex justify-content-center align-items-center">
                  <div class="fruit_img-box d-flex justify-content-center ">
                      <img src="${pageContext.request.contextPath}/assets/user/dist/images/hoaboa3.png" alt="" alt="" class="" width="250px" />
                  </div>
              </div>
          </div>
          <div class="row layout_padding2-top layout_padding-bottom">
              ...
              <div class="col-md-4 d-flex justify-content-center align-items-center">
                  <div class="fruit_img-box d-flex justify-content-center align-items-center">
                      <img src="${pageContext.request.contextPath}/assets/user/dist/images/giohoa13.png" alt="" class="" width="250px" />
                  </div>
              </div>
          </div>
      </div>
